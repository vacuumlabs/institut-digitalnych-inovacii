...
const Members = () => {
  return (
    <>
      <div className="with-backdrop relative py-8 before:hidden lg:py-28 lg:before:top-[350px] lg:before:block lg:before:h-[580px] xl:before:top-[275px] xl:before:h-[490px]">
